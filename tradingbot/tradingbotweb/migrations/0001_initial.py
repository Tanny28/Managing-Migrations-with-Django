    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_currency_values', models.DecimalField(decimal_places=2, max_digits=10)),
                ('destination_currency_values', models.DecimalField(decimal_places=2, max_digits=10)),
